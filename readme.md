...
| geminiModel          | -             | Gemini model. If empty the default model `gemini-3.5-flash-lite:generateContent` is used. Add a specific model or use the `GOOGLE_GEMINI_MODEL` environment variable instead   |
